...
class CommandLineInterfaceAnalysis(object):
    def rw_stability(self, index_location, index_type, ranking_function, rw_length, rw_repeats,
                     topics_path, output_path, limit=1000, repeats=100, method='kendall_w', force=False):
        loop = asyncio.get_event_loop()
        try:
            loop.run_until_complete(
                random_walk_concordance_test(index_location, index_type, ranking_function, rw_length, rw_repeats,
